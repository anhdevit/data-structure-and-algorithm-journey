...
class HashTable {
  ...
  // This hashing functions uses string charcode values to create a unique hash. This is why primary keys being using are important
  makeHash(str) {
    let hash = 0;
...
hash.insert('Tuan Anh', 20); // Will create a bucket at hash.storage[9] and insert list with node of key, value
